...
(function($) {
  $(document).ready(function() {
   ...
   /*  if ($('.ct-productCart-link1').length > 0) {
      $('.ct-productCart-link1').on('click', function(){
        //var $div1 = $('.ct-productCart-link1');
         $('.ct-cart').animate({right:'0px'});
  ...
  $(".ct-js-cart__button").on('click',function(){
    $(".ct-cart").toggle();
  });
